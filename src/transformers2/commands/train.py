...
from transformers2 import SingleSentenceClassificationProcessor as Processor
from transformers2 import TextClassificationPipeline, is_tf_available, is_torch_available
